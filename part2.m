...
global legendshow;
if flag==1
    legendshow{q}=(['(',num2str(n),',',num2str(k),')ÂëÎóÂëÇúÏß']);
else
    legendshow{q}=(['(',num2str(r),',1)ÂëÎóÂëÇúÏß']);
end
legend(legendshow)
xlabel('ÐÅµÀÎó±ÈÌØÂÊ')
ylabel('ÎóÂëÂÊ')
...
hist2=imhist(image2);
figure(2)
subplot(2,2,1),imshow(image),title('Ô­Í¼')
subplot(2,2,2),imshow(image0),title('Î´±àÂë')
subplot(2,2,3),imshow(image1),title(['(',num2str(n),',',num2str(k),')Âë'])
subplot(2,2,4),imshow(image2),title(['(',num2str(r),',1)Âë'])
suptitle('Í¼Ïñ')
figure(3)
subplot(2,2,1),bar(hist),xlim([0,256]),title('Ô­Í¼')
subplot(2,2,2),bar(hist0),xlim([0,256]),title('Î´±àÂë')
subplot(2,2,3),bar(hist1),xlim([0,256]),title(['(',num2str(n),',',num2str(k),')Âë'])
subplot(2,2,4),bar(hist2),xlim([0,256]),title(['(',num2str(r),',1)Âë'])
suptitle('»Ò¶ÈÖ±·½Í¼')
